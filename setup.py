...
setup(
    name=MODULE_SLUG,
    version="0.1.0",
    author="henriquebrnetto",
    author_email="henriquebrnetto02@gmail.com",
    description="Utilizando SVD para prever avaliações de filmes",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/henriquebrnetto/svd",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'svd-cli={MODULE_SLUG}.main:app',
        ],
    },
